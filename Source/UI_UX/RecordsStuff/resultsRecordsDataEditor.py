...
class ResultsRecordsDataEditor:
    ...
    def createTab(self, index: int, record: Record) -> None:
        ...
        """
        tab_frame = record.createDataFrame(self.notebook, self.applicationSettings, True)
    ...
    def addTemporaryTab(self) -> None:
        ...
        self.tempLabel.pack(pady=round(0.25 * self.applicationSettings['window-height']))  # Packing the label in the temporary tab
