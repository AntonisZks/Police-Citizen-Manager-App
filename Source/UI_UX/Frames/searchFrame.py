...
class SearchFrame(IFrame):
    ...
    def _setupStructureOptions(self, parentWidgetSettings: dict[str, Any]) -> None:
        ...
        self.body_options = {
            ...
            "search-bar-width": round(30*(self.applicationSettings['window-width']/self.applicationSettings['window-height'])),
            ...
            "list-visualizer-height": round(0.45 * (self.applicationSettings['window-height'])),
            "data-visualizer-width": round(0.65 * self.applicationSettings['window-width']),
            "data-visualizer-height": round(0.585 * self.applicationSettings['window-height']),
