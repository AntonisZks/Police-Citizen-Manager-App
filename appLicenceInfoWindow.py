...
class AppLicenceInfoWindow:
    ...
    def create_main_label(self):
        ...
        self.main_label = tk.Label(self.window, text="ΑΔΕΙΑ ΧΡΗΣΗΣ", font=('Arial', int(self.font_size*(1.1)), 'bold'), fg="white", bg="#2A508C", 
    ...
    def create_text_area(self):
        ...
        with open(APPLICATION_LICENCE_INFO_PATH_, "r", encoding="utf-8") as file:
